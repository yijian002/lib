var Calendar = (function() {
    ...
    function h(u) {
        var s, t = 348;
        for (s = 32768; s > 8; s >>= 1) { t += (g[u - 1900] & s) ? 1 : 0 }
        return (t + f(u))
    }
